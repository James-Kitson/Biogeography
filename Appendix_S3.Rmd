...
knitr::opts_chunk$set(echo = FALSE,
                      ...
                      fig.align='center')
```
#Appendix S3: Statistical Analyses for Kitson *et al.* 2016
...
###S3.1.1 RASP BBM ancestral state reconstruction.
```{r echo=FALSE}
...
###S3.2.1 R Maximum Likelihood ancestral state reconstruction.
```{r echo=FALSE}
