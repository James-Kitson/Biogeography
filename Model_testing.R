...
dist.mat<-"Metadata/BioGeoBEARS_dist_scale.txt"
...
#######################################################
# Plot ancestral states - DECX
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+X on Cratopus MCC tree"
...
#######################################################
# Plot ancestral states - DECJX
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J+X on Cratopus MCC tree"
...
analysis_titletxt ="BioGeoBEARS DIVALIKE on Cratopus MCC tree"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Cratopus MCC tree"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+X on Cratopus MCC tree"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J+X on Cratopus MCC tree"
...
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Cratopus MCC tree"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Cratopus MCC tree"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J+X on Cratopus MCC tree"
...
restable_AIC_rellike$rel_mod_likeli<-exp(restable_AIC_rellike$deltaAIC/2)

restable_AICc_rellike$deltaAICc<-min(restable_AICc_rellike$AICc)-restable_AICc_rellike$AICc
restable_AICc_rellike$rel_mod_likeli<-exp(restable_AICc_rellike$deltaAICc/2)
