########################################################################################################
### Script for using BioGeoBEARS to estimate ancentral ranges.
########################################################################################################
...
#######################################################
# Geography file notes from BioGeoBEARS
...
# (from Ree & Smith 2008)
cratopus.dist <- "Data/BioGeoBEARS_dist.txt"

# Look at the raw geography text file:
moref(cratopus.dist)

# Look at your geographic range data:
tipranges = getranges_from_LagrangePHYLIP(lgdata_fn=cratopus.dist)
tipranges
...
BioGeoBEARS_run_object$my.tree = my.tree

# Give BioGeoBEARS the location of the geography text file
BioGeoBEARS_run_object$cratopus.dist = cratopus.dist
...
dir.create("Data/BioGeoBEARS_save_files", showWarnings = FALSE)

# For a slow analysis, run once, then set runslow=FALSE to just
# load the saved result.
runslow = TRUE
resfn = "Data/BioGeoBEARs_save_files/Cratopus_DEC.Rdata"
if (runslow)
{
...
resfn = "Data/BioGeoBEARs_save_files/Cratopus_DEC+J.Rdata"
runslow = TRUE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "Diagrams/Cratopus_DEC_vs_DEC+J.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on resolved Cratopus tree"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tree.resolve, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tree.resolve, tipranges=tipranges)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on resolved Cratopus tree"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.7, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tree.resolve, tipranges=tipranges)
...
#### This is as far as I've got with the processing.
