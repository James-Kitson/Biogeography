...
tree.resolve<-read.nexus("Data/trees/concatenated_loci/resolved_tree.nex")
...
tree.resolve$node.label<-as.numeric(tree.resolve$node.label)
tree.resolve$node.label<-round(tree.resolve$node.label,digits=2)
